...
CREATE TABLE colis (
    ...
    statut ENUM( 'initialisation', 'fragile', 'openable', 'livraison_vendeur', 'echec') DEFAULT 'initialisation',
...
INSERT INTO colis (
    ...
    quantite, poids, prix_livraison, statut, type_vente, date_creation
) VALUES 
(
    'Produit A', 'Client A', '067777754345', '123 Rue Exemple', 'Wilaya A', 'A Domicile', 99.99,
    2, 1.5, 10.00, 'fragile', 'Commerce électronique', CURDATE()
)