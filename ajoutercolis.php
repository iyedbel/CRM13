...
// Créer une variable pour la date actuelle
$date_creation = date("Y-m-d H:i:s");

// Préparer la requête avec la date actuelle
$stmt = $pdo->prepare("INSERT INTO colis (nom_produit, nom_client, telephone, adresse, wilaya, type_livraison, prix_vente, quantite, poids, prix_livraison, type_vente, date_creation) VALUES (:nom_produit, :nom_client, :telephone, :adresse, :wilaya, :type_livraison, :prix_vente, :quantite, :poids, :prix_livraison, :type_vente, :date_creation)");
